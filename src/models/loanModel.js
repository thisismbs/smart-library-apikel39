...
export const LoanModel = {
  ...
  async returnBook(loanId) {
    const client = await pool.connect(); // Mulai Transaksi SQL
    try {
      ...
      if (loanResult.rowCount === 0) throw new Error("Peminjaman tidak valid/sudah dikembalikan.");
      ...
      return { message: "Buku berhasil dikembalikan dan stok bertambah!" };
    } catch (error) {
